defmodule Cachex.Services.InformantTest do
  ...
  test "notifying a list of Hooks" do
    ...
    [hook1] = Cachex.Cache.get(cache1).pre_hooks
    [hook2] = Cachex.Cache.get(cache2).post_hooks
    [hook3] = Cachex.Cache.get(cache3).post_hooks
    [hook4] = Cachex.Cache.get(cache4).post_hooks
