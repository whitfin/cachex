  ...
  def project do
    [
      ...
      docs: [
        ...
        extras: [
          "docs/features/extensions/custom-commands.md",
          "docs/features/extensions/execution-lifecycle.md",
          "docs/features/general/action-blocks.md",
          "docs/features/general/disk-interaction.md",
          "docs/features/general/streaming-caches.md",
          "docs/features/management/limiting-caches.md",
          "docs/features/management/expiring-records.md",
          "docs/features/routing/distributed-caches.md",
          "docs/features/warming/reactive-warming.md",
          "docs/features/warming/proactive-warming.md",
          "docs/migrations/migrating-to-v3.md",
          "docs/migrations/migrating-to-v2.md",
          "README.md"
        ],
        groups_for_extras: [
          General: Path.wildcard("docs/features/general/*.md"),
          Management: Path.wildcard("docs/features/management/*.md"),
          Routing: Path.wildcard("docs/features/routing/*.md"),
          Warming: Path.wildcard("docs/features/warming/*.md"),
          Extensions: Path.wildcard("docs/features/extensions/*.md"),
